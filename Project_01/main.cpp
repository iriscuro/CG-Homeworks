...
int main()
{
	...
	float starVertices[] = {
		0.0f,  0.5f, 0.0f,  1.0f, 0.5f, 1.0f, // PUNTA
		0.09f, 0.18f, 0.0f,  1.0f, 0.7f, 1.0f,  
		0.5f,  0.2f, 0.0f,  0.0f, 0.5f, 1.0f, 
		0.16f, -0.12f, 0.0f,  0.0f, 0.5f, 1.0f, 
		0.3f,  -0.5f, 0.0f,  0.0f, 0.5f, 1.0f, 
	...
	// Define los índices para las diferentes primitivas
